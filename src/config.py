...
COARSE_POSE_TOLERANCE = [0.08, 0.08, 0.06, float("inf"), float("inf"), 0.05]
...
# BALLAST PARAMS
BALLAST_SCUBA_SERVO_INDEX = 0
BALLAST_TANK_OUTLET_SERVO_INDEX = 1
BALLAST_SCUBA_VALVE_FULL_OPEN_PWM = 1776
BALLAST_TANK_OUTLET_FULL_OPEN_PWM = 1760
BALLAST_TANK_OUTLET_CLOSED_PWM = 1500
BALLAST_SCUBA_VALVE_CLOSED_PWM = 1500

BALLAST_AIR_FILL_TIME_SECONDS = 2.0
