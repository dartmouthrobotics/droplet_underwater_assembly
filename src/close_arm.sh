#! /bin/bash
# arm the robot
echo "Starting gripper close sequence"
echo "Arming robot"
rosservice call /mavros/cmd/arming "value: true"

echo "Moving gripper"
rostopic pub /mavros/rc/override mavros_msgs/OverrideRCIn "channels: [1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1450, 1500, 1500, 1500]" --once
sleep 2
rostopic pub /mavros/rc/override mavros_msgs/OverrideRCIn "channels: [1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1450, 1500, 1500, 1500]" --once
sleep 1
