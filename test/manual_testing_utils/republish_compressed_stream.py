...
def compressed_image_callback(compressed_image):
    ...
    output_message.header.frame_id = "/cam0_optical_frame"
...
def initialize_compressed_republish_node():
    ...
    compressed_image_in_topic = "/camera_array/cam0/image_raw/compressed"
    output_topic = "/camera_array/cam0/image_raw" 
